...
tl.addLabel("start")
  .to(".rocket_IMG", {x: 3 , y: 1 , duration: 1000})
  .to(".rocket_IMG", {x: -4 , y: -2, duration: 1000})
  .to(".rocket_IMG", {x: 4 , y: 4, duration: 1000})
  .to(".rocket_IMG", {x: -3 , y: 1, duration: 1000})
  .to(".rocket_IMG", {x: 4 , y: -1, duration: 1000})
  .to(".rocket_IMG", {x: -3 , y: 1, duration: 1000})
  .to(".rocket_IMG", {x: 4 , y: -1, duration: 1000})
  .to(".rocket_IMG", {x: -3 , y: 1, duration: 1000})
  .to(".rocket_IMG", {x: 3 , y: 1 , duration: 1000})
  .to(".rocket_IMG", {x: -4 , y: -2, duration: 1000})
  .to(".rocket_IMG", {x: 2 , y: 1, duration: 1000})
  .to(".rocket_IMG", {x: -3 , y: 1, duration: 1000})
  .to(".rocket_IMG", {x: 4 , y: -1, duration: 1000})
  .to(".rocket_IMG", {x: -3 , y: 1, duration: 1000})
  .to(".rocket_IMG", {x: 4 , y: -1, duration: 1000})
  ...
  .to(".rocket_IMG", {x: 4 , y: -1, duration: 1000})
  .to(".rocket_IMG", {x: -3 , y: 1, duration: 1000})
  .to(".rocket_IMG", {y: -300, duration: 10000})
  .to(".earth_IMG", {opacity: 0, y: 400 , duration: 15000})
  .to(".rocket_IMG", {rotate: 45, duration: 5000})
  .to(".rocket_IMG", {rotate: 45, duration: 5000})
  .to(".rocket_IMG", {x: 600 , opacity: 0, duration: 15000})
  .fromTo(".header__mainTitle", {x: -50, opacity: 0}, {x: 0, opacity: 1, duration: 20000})
  .fromTo(".header__secondTitle", {x: -50, opacity: 0}, {x: 0 , opacity: 1, duration: 20000})
  .fromTo(".header__title__horizontalLine", {x: -50, opacity: 0}, {x: 0 , opacity: 1, duration: 20000})
